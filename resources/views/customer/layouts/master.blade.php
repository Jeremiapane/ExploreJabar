...
<head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" href="{{ asset('assets/customer/css/vendors.css') }}">
...
<body>
    <div class="preloader js-preloader">
        ...
        <div class="preloader__title">Explore Jabar</div>
    </div>
    ...
    <script src="{{ asset('assets/customer/js/vendors.js') }}"></script>
