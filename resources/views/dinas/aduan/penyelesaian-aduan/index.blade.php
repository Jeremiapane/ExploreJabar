<x-dinas.layout title="Penyelesaian Aduan">
    ...
    <div class="container mx-auto rounded-lg bg-white p-6 shadow-md">
        <div class="mb-6 flex flex-row items-center justify-between">
            <div class="mb-4 w-full sm:mb-0 sm:w-auto">
                <h1 class="text-3xl font-semibold text-gray-800">Daftar Aduan Diproses</h1>
                <p class="text-gray-600">Berikut adalah daftar aduan yang telah diverifikasi. Klik tombol "Proses"
                    untuk
                    memberikan penyelesaian kepada wisatawan.</p>
            </div>
        </div>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table id="penyelesaian-aduan-table" class="min-w-full overflow-hidden rounded-lg bg-white shadow-md">
                <thead class="bg-gray-50 text-xs uppercase text-gray-700">
                    <tr>
                        <th scope="col" class="cursor-pointer px-6 py-3" data-sort="status" data-column="0"
                            onclick="sortTable(0)">
                        ...
                        <th scope="col" class="cursor-pointer px-6 py-3" data-sort="tanggal" data-column="3"
                            onclick="sortTable(3)">
                            <div class="flex items-center">
                                Verifikatur
                                <svg class="ms-1.5 h-4 w-4 min-w-[1rem] max-w-[1.5rem]" aria-hidden="true"
                        ...
                        <th scope="col" class="cursor-pointer px-6 py-3" data-sort="status"
                            data-column="4"onclick="sortTable(4)">
                            <div class="flex items-center">
                                Status
                                <svg class="ms-1.5 h-4 w-4 min-w-[1rem] max-w-[1.5rem]" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @include('dinas.aduan.penyelesaian-aduan.partials.table', [
                        'aduans' => $aduans,
                    ])
                </tbody>
            </table>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const table = document.getElementById('penyelesaian-aduan-table');
                ...
                searchInput.addEventListener('input', () => {
                    ...
                    rows.forEach(row => {
                        const nameCell = row.querySelector(
                            'td:nth-child(2)'); // Menargetkan kolom judul
            ...
            function searchData(query) {
                axios.get('{{ route('dinas.penyelesaian-aduan.index') }}', {
                        params: {
                            search: query
                        }
                    })
